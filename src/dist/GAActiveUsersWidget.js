...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./GAActiveUsersWidget.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./GAActiveUsersWidget.scss");
...
};var columns = [{ type: 'string', label: 'Day' }, { type: 'number', label: 'DAU' }, { type: 'number', label: 'WAU' }, { type: 'number', label: 'MAU' }];
  ...
  return {
    createComponent: function createComponent(React, Component) {
      return function (_Component) {
        _inherits(GAActiveUsersWidget, _Component);

        function GAActiveUsersWidget(props) {
          _classCallCheck(this, GAActiveUsersWidget);
        ...
        _createClass(GAActiveUsersWidget, [{
